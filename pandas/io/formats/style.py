...
class Styler(StylerRenderer):
    ...
    * Data cells include ``data``
    ...
    def set_header_styles(
        self,
        keys: IndexLabel | list[IndexLabel] = None,
        axis: str | int = "both",
        props: CSSProperties = "font-weight: bold;",
        index_levels: list[int] | None = None,
        column_levels: list[int] | None = None,
    ) -> Styler:
        """
        ...
        props = maybe_convert_css_to_tuples(props)
        ...
        index_styles: CSSStyles = []
        column_styles: CSSStyles = []
